<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="健康师账号" prop="jiankangshizhanghao">
          <el-input v-model="ruleForm.jiankangshizhanghao" 
              placeholder="健康师账号" clearable  :readonly="ro.jiankangshizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="健康师账号" prop="jiankangshizhanghao">
              <el-input v-model="ruleForm.jiankangshizhanghao" 
                placeholder="健康师账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="健康师姓名" prop="jiankangshixingming">
          <el-input v-model="ruleForm.jiankangshixingming" 
              placeholder="健康师姓名" clearable  :readonly="ro.jiankangshixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="健康师姓名" prop="jiankangshixingming">
              <el-input v-model="ruleForm.jiankangshixingming" 
                placeholder="健康师姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="个人履历" prop="gerenlvli">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gerenlvli" label="个人履历" prop="gerenlvli">
                    <span v-html="ruleForm.gerenlvli"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	zhaopian : false,
      ...
      rules: {
          jiankangshizhanghao: [
                { required: true, message: '健康师账号不能为空', trigger: 'blur' },
          ],
          mima: [
                { required: true, message: '密码不能为空', trigger: 'blur' },
          ],
          jiankangshixingming: [
                { required: true, message: '健康师姓名不能为空', trigger: 'blur' },
          ],
          lianxifangshi: [
  ...
  methods: {
	...
	this.ruleForm.gerenlvli = this.ruleForm.gerenlvli.replace(reg,'../../../springboot0m6og/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiankangfenxishi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiankangfenxishiCrossAddOrUpdateFlag = false;
						 this.parent.search();
