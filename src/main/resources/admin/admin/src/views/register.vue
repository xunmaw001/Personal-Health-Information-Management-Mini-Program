  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jiankangfenxishi'" class="input-group">
			   <div class="label">健康师账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiankangshizhanghao" class="input" type="text" placeholder="健康师账号">
			   </div>
			 </div> -->
			<el-form-item label="健康师账号" class="input" v-if="tableName=='jiankangfenxishi'">
			  <el-input v-model="ruleForm.jiankangshizhanghao" autocomplete="off" placeholder="健康师账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiankangfenxishi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiankangfenxishi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='jiankangfenxishi'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='jiankangfenxishi'" class="input-group">
			   <div class="label">健康师姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiankangshixingming" class="input" type="text" placeholder="健康师姓名">
			   </div>
			 </div> -->
			<el-form-item label="健康师姓名" class="input" v-if="tableName=='jiankangfenxishi'">
			  <el-input v-model="ruleForm.jiankangshixingming" autocomplete="off" placeholder="健康师姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiankangfenxishi'" class="input-group">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='jiankangfenxishi'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='jiankangfenxishi'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `jiankangfenxishi` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.jiankangshixingming) && `jiankangfenxishi` == this.tableName){
        this.$message.error(`健康师姓名不能为空`);
        return
      }
