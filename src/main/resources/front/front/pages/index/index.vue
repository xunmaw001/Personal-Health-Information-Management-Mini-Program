<template>
    ...
    <!-- 新闻资讯 -->
      ...
      <view class="title" :style='{"padding":"0 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0, 186, 189, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
        <view :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(130, 163, 157, 1)","backgroundColor":"rgba(203, 214, 211, 1)","color":"rgba(255, 255, 255, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0 0 0 8rpx","width":"50%","fontSize":"32rpx","lineHeight":"80rpx","borderStyle":"solid"}'>通知公告</view>
	...
	<!-- 商品列表 -->
	  ...
	  <view class="title" :style='{"padding":"0 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"20rpx 0 0 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0, 186, 189, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
	    <view :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(130, 163, 157, 1)","backgroundColor":"rgba(203, 214, 211, 1)","color":"#FFF","textAlign":"left","borderRadius":"0","borderWidth":"0 0 0 8rpx","width":"50%","fontSize":"32rpx","lineHeight":"80rpx","borderStyle":"solid"}'>健康手册</view>
	    <text :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(130, 163, 157, 1)","textAlign":"right","borderRadius":"0","borderWidth":"0","width":"50%","lineHeight":"80rpx","fontSize":"32rpx","borderStyle":"solid"}' @tap="onPageTap('jiankangshouce')">查看更多</text>
	  </view>
	  ...
	  <view v-if="1 == 1" class="list-box style1" :style='{"padding":"20rpx 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
	    <view @tap="onDetailTap('jiankangshouce',product.id)" v-for="(product,index) in homejiankangshoucelist" :key="index" class="list-item" :style='{"padding":"20rpx","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 20rpx","borderColor":"rgba(130, 163, 157, 1)","backgroundColor":"#fff","borderRadius":"40rpx","borderWidth":"2rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
	  ...
	  <view class="title" :style='{"padding":"0 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"20rpx 0 0 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0, 186, 189, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
	    <view :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(130, 163, 157, 1)","backgroundColor":"rgba(203, 214, 211, 1)","color":"#FFF","textAlign":"left","borderRadius":"0","borderWidth":"0 0 0 8rpx","width":"50%","fontSize":"32rpx","lineHeight":"80rpx","borderStyle":"solid"}'>健康饮食</view>
	    <text :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(130, 163, 157, 1)","textAlign":"right","borderRadius":"0","borderWidth":"0","width":"50%","lineHeight":"80rpx","fontSize":"32rpx","borderStyle":"solid"}' @tap="onPageTap('jiankangyinshi')">查看更多</text>
	  </view>
	  <view v-if="false && 1 == 2" class="idea listIdea" :style='{"padding":"20rpx 10rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"20rpx 0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"rgba(0,0,0,.3)","width":"100%","borderStyle":"solid","height":"auto"}'>
	  	<view class="box box1"></view>
	  	<view class="box box2"></view>
	  	...
	  	<view class="box box4"></view>
	  	  ...
	  	  <!-- 样式1 -->
	  <view v-if="1 == 1" class="list-box style1" :style='{"padding":"20rpx 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
	    <view @tap="onDetailTap('jiankangyinshi',product.id)" v-for="(product,index) in homejiankangyinshilist" :key="index" class="list-item" :style='{"padding":"20rpx","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 20rpx","borderColor":"rgba(130, 163, 157, 1)","backgroundColor":"#fff","borderRadius":"40rpx","borderWidth":"2rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
	      	      	      <view :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","borderStyle":"solid"}' class="list-item-title hide1">{{product.biaoti}}</view>
	...
	export default {
		...
		data() {
			return {
				...
				//轮播
				swiperList: [],
				homejiankangshoucelist: [],
				homejiankangyinshilist: [],
				news: [],
			}
		},
		computed: {
		...
		async onShow() {
			...
			res = await this.$api.list('jiankangshouce', {
				page: 1,

				limit: 4
			});
			this.homejiankangshoucelist = res.data.list
			res = await this.$api.list('jiankangyinshi', {
				page: 1,

				limit: 4
			});
			this.homejiankangyinshilist = res.data.list
		},
